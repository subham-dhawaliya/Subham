...
Most of my experience comes from personal projects, freelance work, and continuous learning, where I focus on writing clean, maintainable, and scalable code.
...
|----------|-------------|------|
| Portfolio Website | Personal portfolio with modern UI | HTML, CSS, JS |
| Management System | Complete dashboard system | Laravel, MySQL |
| E-Commerce App | Product & order management | Laravel |
| Blog Platform | Content management website | PHP, MySQL |

---

# 🚧 Currently Working On

- Improving Laravel skills
- Learning React.js
